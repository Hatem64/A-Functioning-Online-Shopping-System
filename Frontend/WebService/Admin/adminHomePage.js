...
createProductCompanyAccountsForm.addEventListener('submit', (event) => {
    ...
    fetch('http://localhost:8080/OnlineShoppingSystemUserSide-1.0-SNAPSHOT/api/admin/createProductCompanyAccount', {
        method: 'POST',
...
createShippingCompaniesForm.addEventListener('submit', (event) => {
    ...
    fetch('http://localhost:8080/OnlineShoppingSystemUserSide-1.0-SNAPSHOT/api/admin/createShippingCompany', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
shippingCompaniesButton.addEventListener('click', () => {
    if (shippingCompaniesVisible) {
        ...
        fetch('http://localhost:8080/OnlineShoppingSystemUserSide-1.0-SNAPSHOT/api/admin/listShippingCompanies')
...
productCompaniesButton.addEventListener('click', () => {
    if (productCompaniesVisible) {
        ...
        fetch('http://localhost:8080/OnlineShoppingSystemUserSide-1.0-SNAPSHOT/api/admin/listSellingCompanies')
            .then(response => response.json())
            .then(data => {
...
listClientsButton.addEventListener('click', () => {
    if (isListVisible) {
        ...
        fetch('http://localhost:8080/OnlineShoppingSystemUserSide-1.0-SNAPSHOT/api/admin/listClients')
            .then(response => response.json())
            .then(clients => {
